...
import com.cappuccino.backend.persistence.domain.backend.PasswordResetToken;
import com.cappuccino.backend.persistence.domain.backend.User;
import com.cappuccino.backend.persistence.repositories.PasswordResetTokenRepository;
...
public class PasswordResetTokenService {
    ...
    /**
     * Creates a new Password Reset Token for the user identified by the given user email
     * @param email The email uniquely identifying the user
     * @return a new Password Reset Token for the user identified by the given email or null if non was found
     */
    @Transactional
    public PasswordResetToken createPasswordResetTokenForEmail(String email) {
        ...
        if (null != user) {
            ...
            LOG.warn("We could not find a user for the given email {}", email);
        }
